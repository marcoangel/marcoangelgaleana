...
<section class="resume-section" id="experience">
    <div class="resume-section-content">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between">
            <div class="flex-grow-1">
                <h3 class="mb-0">Docente tiempo parcial </h3>
                <div class="subheading mb-3">Tecnologico Playacar . Playa del carmen, Quintana Roo</div>
                <p>Docente de tiempo parcial en la carrera de Sistemas Computacionales, impartiendo materias como programación orientada a objetos, algoritmos y base de datos.</p>
            </div>
            <div class="flex-shrink-0"><span class="text-primary">Agosto 2023 - Actual</span></div>
        </div>
    </div>
</section>
<hr class="m-0" />